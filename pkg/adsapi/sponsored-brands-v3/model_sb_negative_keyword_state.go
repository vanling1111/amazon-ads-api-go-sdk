...
// SbNegativeKeywordState : The current state of the negative keyword.
type SbNegativeKeywordState string

// List of SBNegativeKeywordState
const (
	ENABLED_SbNegativeKeywordState  SbNegativeKeywordState = "enabled"
	ARCHIVED_SbNegativeKeywordState SbNegativeKeywordState = "archived"
	DRAFT_SbNegativeKeywordState    SbNegativeKeywordState = "draft"
)
