...
// NegativeMatchType : The type of match. For more information, see [match types](https://advertising.amazon.com/help#GHTRFDZRJPW6764R) in the Amazon Ads support center.
type NegativeMatchType string

// List of NegativeMatchType
const (
	NEGATIVE_EXACT_NegativeMatchType NegativeMatchType = "negativeExact"
	NEGATIVE_PHRASE_NegativeMatchType NegativeMatchType = "negativePhrase"
)
