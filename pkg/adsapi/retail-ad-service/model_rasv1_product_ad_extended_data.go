...
type Rasv1ProductAdExtendedData struct {
	// Creation date in ISO 8601.
	CreationDateTime time.Time `json:"creationDateTime,omitempty"`
	// Last updated date in ISO 8601.
	LastUpdateDateTime time.Time `json:"lastUpdateDateTime,omitempty"`
	ServingStatus *Rasv1ProductAdServingStatus `json:"servingStatus,omitempty"`
	// The serving status reasons of the ProductAd
	ServingStatusDetails []Rasv1ProductAdServingStatusDetailItem `json:"servingStatusDetails,omitempty"`
}
