...
type Rasv1BulkMutateCampaignsOutcomes struct {
	Error_ []Rasv1MutateCampaignFailureItem `json:"error,omitempty"`
	Success []Rasv1MutateCampaignSuccessItem `json:"success,omitempty"`
}
