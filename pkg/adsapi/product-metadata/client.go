...
// APIClient manages communication with the Product Selector API v3.0
...
type APIClient struct {
	...
	ProductSelectorApi *ProductSelectorApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.ProductSelectorApi = (*ProductSelectorApiService)(&c.common)
