...
type Rasv1EntityNotFoundErrorReason string

// List of RASv1EntityNotFoundErrorReason
const (
	ENTITY_NOT_FOUND_Rasv1EntityNotFoundErrorReason Rasv1EntityNotFoundErrorReason = "ENTITY_NOT_FOUND"
)
