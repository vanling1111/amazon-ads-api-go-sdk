...
/*
ReportsApiService Gets an attribution report for a specified list of advertisers.
...
*/
func (a *ReportsApiService) GetAttributionTagsByCampaign(ctx context.Context, body ReportRequestBody, amazonAdvertisingAPIClientId string, amazonAdvertisingAPIScope string) (ReportResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/attribution/report"
