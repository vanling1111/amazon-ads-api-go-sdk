...
type InlineResponse2007TargetsBidsRecommendationSuccessResults struct {
	// The identifier of the target bid recommendation.
	RecommendationId *Object `json:"recommendationId,omitempty"`
	RecommendedBid *RecommendedBid `json:"recommendedBid,omitempty"`
	Targets *[]SbExpression `json:"targets,omitempty"`
	TargetsIndex float64 `json:"targetsIndex,omitempty"`
}
