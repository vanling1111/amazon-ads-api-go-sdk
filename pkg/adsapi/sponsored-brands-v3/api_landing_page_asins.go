...
type LandingPageAsinsApiService service

/*
LandingPageAsinsApiService Gets ASIN information for a specified address.
Note that for sellers, the addresss must be a Store page. Vendors may also specify a custom landing page address. Only the &#x60;ASINs&#x60; that are directly associated on creation with a Store landing page are returned by this API. Any other &#x60;ASINs&#x60; that are not directly associated to the Store landing page or are listed on other pages are not returned by this API. This includes &#x60;ASINs&#x60; that are on Dynamic widgets, product selections, and featured deals widgets.
  ...
  - @param pageUrl For sellers, the address of a Store page. Vendors may also specify the address of a custom landing page. For more information, see the [Stores section](https://advertising.amazon.com/help#GPRM3ZHEXEY5RBFZ) of the Amazon Ads support center.

@return InlineResponse2002
*/
func (a *LandingPageAsinsApiService) ListAsins(ctx context.Context, amazonAdvertisingAPIClientId string, amazonAdvertisingAPIScope string, pageUrl string) (InlineResponse2002, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/pageAsins"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}

	localVarQueryParams.Add("pageUrl", parameterToString(pageUrl, ""))
	...
	localVarHttpHeaderAccepts := []string{"application/vnd.pageasins.v3+json"}
