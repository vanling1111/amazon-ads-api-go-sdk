...
// APIClient manages communication with the Manager Account API v3.0
...
type APIClient struct {
	...
	ManagerAccountsApi *ManagerAccountsApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.ManagerAccountsApi = (*ManagerAccountsApiService)(&c.common)
