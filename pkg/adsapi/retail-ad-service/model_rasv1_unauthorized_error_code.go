...
type Rasv1UnauthorizedErrorCode string

// List of RASv1UnauthorizedErrorCode
const (
	UNAUTHORIZED_Rasv1UnauthorizedErrorCode Rasv1UnauthorizedErrorCode = "UNAUTHORIZED"
)
