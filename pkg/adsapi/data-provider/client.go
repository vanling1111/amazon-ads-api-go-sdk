...
// APIClient manages communication with the Amazon Ads API for Data Providers. API v3.0
...
type APIClient struct {
	...
	AddOrRemoveRecordsApi *AddOrRemoveRecordsApiService

	MetadataApi *MetadataApiService

	UserDeletionApi *UserDeletionApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.AddOrRemoveRecordsApi = (*AddOrRemoveRecordsApiService)(&c.common)
	c.MetadataApi = (*MetadataApiService)(&c.common)
	c.UserDeletionApi = (*UserDeletionApiService)(&c.common)
