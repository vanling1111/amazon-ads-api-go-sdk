...
type Rasv1AdGroupExtendedData struct {
	// Creation date in ISO 8601.
	CreationDateTime time.Time `json:"creationDateTime,omitempty"`
	// Last updated date in ISO 8601.
	LastUpdateDateTime time.Time `json:"lastUpdateDateTime,omitempty"`
	ServingStatus *Rasv1AdGroupServingStatus `json:"servingStatus,omitempty"`
	// The serving status reasons of the AdGroup
	ServingStatusDetails []Rasv1AdGroupServingStatusDetailItem `json:"servingStatusDetails,omitempty"`
}
