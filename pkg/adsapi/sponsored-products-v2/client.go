...
// APIClient manages communication with the Amazon Ads API - Sponsored Products API v2.0
...
type APIClient struct {
	...
	SuggestedKeywordsApi *SuggestedKeywordsApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.SuggestedKeywordsApi = (*SuggestedKeywordsApiService)(&c.common)
