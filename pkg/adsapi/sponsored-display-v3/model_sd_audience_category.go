...
const (
	IN_MARKET_SdAudienceCategory  SdAudienceCategory = "In-market"
	LIFESTYLE_SdAudienceCategory  SdAudienceCategory = "Lifestyle"
	INTEREST_SdAudienceCategory   SdAudienceCategory = "Interest"
	LIFE_EVENT_SdAudienceCategory SdAudienceCategory = "Life event"
)
