...
/*
BudgetUsageApiService Budget usage API for SD campaigns
 ...
 * @param optional nil or *BudgetUsageApiSdCampaignsBudgetUsageOpts - Optional Parameters:
     * @param "Body" (optional.Interface of BudgetUsageCampaignRequest) - 
@return BudgetUsageCampaignResponse
*/

type BudgetUsageApiSdCampaignsBudgetUsageOpts struct {
    Body optional.Interface
}

func (a *BudgetUsageApiService) SdCampaignsBudgetUsage(ctx context.Context, amazonAdvertisingAPIClientId Object, amazonAdvertisingAPIScope Object, localVarOptionals *BudgetUsageApiSdCampaignsBudgetUsageOpts) (BudgetUsageCampaignResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/sd/campaigns/budget/usage"
