...
// APIClient manages communication with the Marketing Mix Modeling API v3.0
...
type APIClient struct {
	...
	BrandGroupsApi *BrandGroupsApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.BrandGroupsApi = (*BrandGroupsApiService)(&c.common)
