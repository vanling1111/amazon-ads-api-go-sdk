...
type CreateTargetingExpressionPredicate struct {
	// Determines the type of targeting. Note that new values can be added to this list in the future. Support for the responses with newly addded values should be ensured for using them at the time of creation. | Predicate | Description | | --- | --- | | CONTENT_CATEGORY_SIMILAR_TO | Target the content genre that is similar to the specified genre | | ASIN_CATEGORY_SIMILAR_TO | Target the category that is similar to the specified category |
