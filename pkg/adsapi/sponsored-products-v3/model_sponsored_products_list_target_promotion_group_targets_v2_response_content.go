...
type SponsoredProductsListTargetPromotionGroupTargetsV2ResponseContent struct {
	...
	Targets []SponsoredProductsTargetPromotionGroupTargetDetails `json:"targets,omitempty"`
