...
type ConversionEventDataApiService service

/*
ConversionEventDataApiService Import conversion event data. This API expects one source per request across all conversion event data and supports partial import. Only conversion event data with matching conversion source will be imported, the rest will be rejected.
 ...
 * @param optional nil or *ConversionEventDataApiDspAmazonIngestConversionDataOpts - Optional Parameters:
...
@return BatchImportConversionEventDataResponseV1
*/

type ConversionEventDataApiDspAmazonIngestConversionDataOpts struct {
	AmazonAdvertisingAPIScope optional.String
	AmazonAdsAccountId        optional.String
}

func (a *ConversionEventDataApiService) DspAmazonIngestConversionData(ctx context.Context, body BatchImportConversionEventDataRequestV1, amazonAdvertisingAPIClientId string, accountId string, localVarOptionals *ConversionEventDataApiDspAmazonIngestConversionDataOpts) (BatchImportConversionEventDataResponseV1, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue BatchImportConversionEventDataResponseV1
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/accounts/{accountId}/dsp/conversionDefinitions/eventData"
	...
	localVarHttpContentTypes := []string{"application/vnd.dspconversioneventimport.v1+json"}
	...
	localVarHttpHeaderAccepts := []string{"application/vnd.dspconversioneventimport.v1+json"}
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 207 {
			var v BatchImportConversionEventDataResponseV1
