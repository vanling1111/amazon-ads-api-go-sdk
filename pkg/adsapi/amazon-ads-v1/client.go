...
// APIClient manages communication with the Amazon Ads API ALL API v3.0
...
type APIClient struct {
	...
	AdAssociationsApi *AdAssociationsApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.AdAssociationsApi = (*AdAssociationsApiService)(&c.common)
