...
/*
PublishersApiService Gets a list of all available publishers.
...
*/
func (a *PublishersApiService) GetPublishers(ctx context.Context, amazonAdvertisingAPIClientId string, amazonAdvertisingAPIScope string) (PublishersResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue PublishersResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/attribution/publishers"
