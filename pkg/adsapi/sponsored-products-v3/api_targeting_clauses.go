 ...
 * @param optional nil or *TargetingClausesApiCreateSponsoredProductsTargetingClausesOpts - Optional Parameters:
...
type TargetingClausesApiCreateSponsoredProductsTargetingClausesOpts struct {
	Prefer optional.String
}

func (a *TargetingClausesApiService) CreateSponsoredProductsTargetingClauses(ctx context.Context, body SponsoredProductsCreateSponsoredProductsTargetingClausesRequestContent, amazonAdvertisingAPIClientId string, amazonAdvertisingAPIScope string, localVarOptionals *TargetingClausesApiCreateSponsoredProductsTargetingClausesOpts) (SponsoredProductsCreateSponsoredProductsTargetingClausesResponseContent, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/sp/targets"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 207 {
			var v SponsoredProductsCreateSponsoredProductsTargetingClausesResponseContent
		...
		if localVarHttpResponse.StatusCode == 400 {
			var v SponsoredProductsTargetMutationExceptionResponseContent
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
*/
func (a *TargetingClausesApiService) DeleteSponsoredProductsTargetingClauses(ctx context.Context, body SponsoredProductsDeleteSponsoredProductsTargetingClausesRequestContent, amazonAdvertisingAPIClientId string, amazonAdvertisingAPIScope string) (SponsoredProductsDeleteSponsoredProductsTargetingClausesResponseContent, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/sp/targets/delete"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 207 {
			var v SponsoredProductsDeleteSponsoredProductsTargetingClausesResponseContent
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
 ...
 * @param amazonAdvertisingAPIClientId The identifier of a client associated with a \&quot;Login with Amazon\&quot; account.
 * @param amazonAdvertisingAPIScope The identifier of a profile associated with the advertiser account. Use GET method on Profiles resource to list profiles associated with the access token passed in the HTTP Authorization header.
 * @param optional nil or *TargetingClausesApiListSponsoredProductsTargetingClausesOpts - Optional Parameters:
     * @param "Body" (optional.Interface of SponsoredProductsListSponsoredProductsTargetingClausesRequestContent) -
@return SponsoredProductsListSponsoredProductsTargetingClausesResponseContent
*/

type TargetingClausesApiListSponsoredProductsTargetingClausesOpts struct {
	Body optional.Interface
}

func (a *TargetingClausesApiService) ListSponsoredProductsTargetingClauses(ctx context.Context, amazonAdvertisingAPIClientId string, amazonAdvertisingAPIScope string, localVarOptionals *TargetingClausesApiListSponsoredProductsTargetingClausesOpts) (SponsoredProductsListSponsoredProductsTargetingClausesResponseContent, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/sp/targets/list"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v SponsoredProductsListSponsoredProductsTargetingClausesResponseContent
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
		...
		if localVarHttpResponse.StatusCode == 400 {
			var v SponsoredProductsTargetAccessExceptionResponseContent
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
 ...
 * @param amazonAdvertisingAPIClientId The identifier of a client associated with a \&quot;Login with Amazon\&quot; account.
 * @param amazonAdvertisingAPIScope The identifier of a profile associated with the advertiser account. Use GET method on Profiles resource to list profiles associated with the access token passed in the HTTP Authorization header.
 * @param optional nil or *TargetingClausesApiUpdateSponsoredProductsTargetingClausesOpts - Optional Parameters:
     * @param "Prefer" (optional.String) -  The \&quot;Prefer\&quot; header, as defined in [RFC7240], allows clients to request certain behavior from the service. The service ignores preference values that are either not supported or not known by the service. Either multiple Prefer headers are passed or single one with comma separated values, both forms are equivalent Supported preferences: return&#x3D;representation - return the full object when doing create/update/delete operations instead of ids. Please note that the extendedData field will be part of the full object for /list endpoints only.
@return SponsoredProductsUpdateSponsoredProductsTargetingClausesResponseContent
*/

type TargetingClausesApiUpdateSponsoredProductsTargetingClausesOpts struct {
	Prefer optional.String
}

func (a *TargetingClausesApiService) UpdateSponsoredProductsTargetingClauses(ctx context.Context, body SponsoredProductsUpdateSponsoredProductsTargetingClausesRequestContent, amazonAdvertisingAPIClientId string, amazonAdvertisingAPIScope string, localVarOptionals *TargetingClausesApiUpdateSponsoredProductsTargetingClausesOpts) (SponsoredProductsUpdateSponsoredProductsTargetingClausesResponseContent, *http.Response, error) {
	var (
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 207 {
			var v SponsoredProductsUpdateSponsoredProductsTargetingClausesResponseContent
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
