...
type SbUpdateDraftCampaignRequestWithProductTargets struct {
	Targets []SbUpdateDraftCampaignRequestWithProductTargetsTargets `json:"targets,omitempty"`
	NegativeTargets []SbUpdateDraftCampaignRequestWithProductTargetsNegativeTargets `json:"negativeTargets,omitempty"`
}
