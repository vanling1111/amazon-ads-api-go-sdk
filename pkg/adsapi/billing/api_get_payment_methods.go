...
type GetPaymentMethodsApiService service

/*
GetPaymentMethodsApiService
 ...
 * @param criteriaType Criteria Types to that can be used to filter the payment methods in the GET Payment methods API.
 * @param optional nil or *GetPaymentMethodsApiGetCustomerPaymentMethodsOpts - Optional Parameters:
...
@return AdPaymentsGetCustomerPaymentMethodsOutput
*/

type GetPaymentMethodsApiGetCustomerPaymentMethodsOpts struct {
...
func (a *GetPaymentMethodsApiService) GetCustomerPaymentMethods(ctx context.Context, amazonAdvertisingAPIClientId string, criteriaType AdPaymentsPaymentAgreementType, localVarOptionals *GetPaymentMethodsApiGetCustomerPaymentMethodsOpts) (AdPaymentsGetCustomerPaymentMethodsOutput, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue AdPaymentsGetCustomerPaymentMethodsOutput
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/billing/paymentMethods/list"
	...
	localVarQueryParams.Add("criteriaType", parameterToString(criteriaType, ""))
	...
	localVarHttpHeaderAccepts := []string{"application/vnd.paymentmethods.v1+json", "application/json"}
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v AdPaymentsGetCustomerPaymentMethodsOutput
