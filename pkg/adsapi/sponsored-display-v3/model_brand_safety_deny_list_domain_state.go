...
const (
	ENABLED_BrandSafetyDenyListDomainState  BrandSafetyDenyListDomainState = "ENABLED"
	ARCHIVED_BrandSafetyDenyListDomainState BrandSafetyDenyListDomainState = "ARCHIVED"
)
