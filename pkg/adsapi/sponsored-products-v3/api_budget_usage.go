...
/*
BudgetUsageApiService Budget usage API for SP campaigns
...
*/
func (a *BudgetUsageApiService) SpCampaignsBudgetUsage(ctx context.Context, body BudgetUsageCampaignRequest, amazonAdvertisingAPIClientId Object, amazonAdvertisingAPIScope Object) (BudgetUsageCampaignResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/sp/campaigns/budget/usage"
	...
	localVarHttpHeaderAccepts := []string{"application/vnd.spcampaignbudgetusage.v1+json", "application/json"}
