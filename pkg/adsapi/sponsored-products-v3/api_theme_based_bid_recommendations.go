...
/*
ThemeBasedBidRecommendationsApiService Get bid recommendations for ad groups
 ...
 * @param optional nil or *ThemeBasedBidRecommendationsApiGetThemeBasedBidRecommendationForAdGroupV1Opts - Optional Parameters:
     * @param "Body" (optional.Interface of BidRecommendationsBody1) -
@return ThemeBasedBidRecommendationResponse
*/

type ThemeBasedBidRecommendationsApiGetThemeBasedBidRecommendationForAdGroupV1Opts struct {
	Body optional.Interface
}

func (a *ThemeBasedBidRecommendationsApiService) GetThemeBasedBidRecommendationForAdGroupV1(ctx context.Context, amazonAdvertisingAPIClientId string, amazonAdvertisingAPIScope string, localVarOptionals *ThemeBasedBidRecommendationsApiGetThemeBasedBidRecommendationForAdGroupV1Opts) (ThemeBasedBidRecommendationResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ThemeBasedBidRecommendationResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/sp/targets/bid/recommendations"
	...
	localVarHttpContentTypes := []string{"application/vnd.spthemebasedbidrecommendation.v3+json", "application/vnd.spthemebasedbidrecommendation.v4+json", "application/vnd.spthemebasedbidrecommendation.v5+json"}
	...
	localVarHttpHeaderAccepts := []string{"application/vnd.spthemebasedbidrecommendation.v3+json", "application/vnd.spthemebasedbidrecommendation.v4+json", "application/vnd.spthemebasedbidrecommendation.v5+json"}
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ThemeBasedBidRecommendationResponse
