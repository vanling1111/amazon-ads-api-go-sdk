...
// NegativeExpressionType : The type of expression.
type NegativeExpressionType string

// List of NegativeExpressionType
const (
	MANUAL_NegativeExpressionType NegativeExpressionType = "manual"
)
