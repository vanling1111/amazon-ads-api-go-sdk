...
// APIClient manages communication with the Hashed Records API v3.0
...
type APIClient struct {
	...
	HashedRecordsApi *HashedRecordsApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.HashedRecordsApi = (*HashedRecordsApiService)(&c.common)
