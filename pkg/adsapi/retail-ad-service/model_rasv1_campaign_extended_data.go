...
type Rasv1CampaignExtendedData struct {
	// Creation date in ISO 8601.
	CreationDateTime time.Time `json:"creationDateTime,omitempty"`
	// Last updated date in ISO 8601.
	LastUpdateDateTime time.Time                   `json:"lastUpdateDateTime,omitempty"`
	ServingStatus      *Rasv1CampaignServingStatus `json:"servingStatus,omitempty"`
	// The serving status reasons of the Campaign
	ServingStatusDetails []Rasv1CampaignServingStatusDetailItem `json:"servingStatusDetails,omitempty"`
}
