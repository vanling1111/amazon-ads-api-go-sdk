...
type Rasv1TargetLevel string

// List of RASv1TargetLevel
const (
	AD_GROUP_Rasv1TargetLevel Rasv1TargetLevel = "AD_GROUP"
	CAMPAIGN_Rasv1TargetLevel Rasv1TargetLevel = "CAMPAIGN"
)
