...
// APIClient manages communication with the Creative assets API v3.0
...
type APIClient struct {
	...
	CreativeAssetsApi *CreativeAssetsApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.CreativeAssetsApi = (*CreativeAssetsApiService)(&c.common)
