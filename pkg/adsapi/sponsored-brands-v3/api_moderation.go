...
/*
ModerationApiService Gets the moderation result for a campaign specified by identifier.
...
*/
func (a *ModerationApiService) SbModerationCampaignsCampaignIdGet(ctx context.Context, amazonAdvertisingAPIClientId string, amazonAdvertisingAPIScope string, campaignId int64) (InlineResponse20017, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/sb/moderation/campaigns/{campaignId}"
	...
	localVarHttpHeaderAccepts := []string{"application/vnd.sbmoderation.v3+json", "application/vnd.error.v3+json"}
