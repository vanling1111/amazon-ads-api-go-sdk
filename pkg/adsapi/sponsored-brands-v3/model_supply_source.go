...
// SupplySource : (As of 05/28/2024, `STREAMING_VIDEO` is deprecated). The supply source of the campaign. Use `AMAZON` for placements on Amazon website. Use `STREAMING_VIDEO` for off-site video placements such as IMDb TV. Default value is `AMAZON`
type SupplySource string

// List of SupplySource
const (
	AMAZON_SupplySource          SupplySource = "AMAZON"
	STREAMING_VIDEO_SupplySource SupplySource = "STREAMING_VIDEO"
)
