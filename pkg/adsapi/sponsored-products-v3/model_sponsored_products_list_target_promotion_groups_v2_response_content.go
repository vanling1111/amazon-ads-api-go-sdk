...
type SponsoredProductsListTargetPromotionGroupsV2ResponseContent struct {
	...
	TargetPromotionGroups []SponsoredProductsTargetPromotionGroupV2 `json:"targetPromotionGroups,omitempty"`
