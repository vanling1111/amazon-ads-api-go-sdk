...
type SbCreateCampaignsResponseFullV33 struct {
	Campaign *SbCampaignResponseV33 `json:"campaign,omitempty"`
	AllOf *SbCreateCampaignsResponseDefault `json:"allOf,omitempty"`
}
