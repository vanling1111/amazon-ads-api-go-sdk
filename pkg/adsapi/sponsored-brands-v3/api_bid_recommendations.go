 ...
 * @param optional nil or *BidRecommendationsApiGetBidsRecommendationsOpts - Optional Parameters:
     * @param "Body" (optional.Interface of RecommendationsBidsBody) -  A list of keywords or targeting expressions for which to generate bid recommendations. Note that if a value is specified for the &#x60;campaignId&#x60; field, the past performance data for the campaign may be use to create bid recommendations.
@return InlineResponse2007
*/

type BidRecommendationsApiGetBidsRecommendationsOpts struct {
	Body optional.Interface
}

func (a *BidRecommendationsApiService) GetBidsRecommendations(ctx context.Context, amazonAdvertisingAPIClientId string, amazonAdvertisingAPIScope string, localVarOptionals *BidRecommendationsApiGetBidsRecommendationsOpts) (InlineResponse2007, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/sb/recommendations/bids"
	...
	localVarHttpHeaderAccepts := []string{"application/vnd.sbbidsrecommendation.v3+json"}
