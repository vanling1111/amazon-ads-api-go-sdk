...
type CreateStoreSpotlightSettings struct {
	...
	Cards []CreateCardCreativeElement `json:"cards,omitempty"`
	// The CreativeProperty Amazon will enhance or generate based on various factors like audience, placement etc.
	CreativePropertiesToOptimize []StoreSpotlightCreativePropertiesToOptimize `json:"creativePropertiesToOptimize,omitempty"`
