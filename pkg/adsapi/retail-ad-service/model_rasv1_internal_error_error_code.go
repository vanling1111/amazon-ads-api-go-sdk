...
type Rasv1InternalErrorErrorCode string

// List of RASv1InternalErrorErrorCode
const (
	INTERNAL_ERROR_Rasv1InternalErrorErrorCode Rasv1InternalErrorErrorCode = "INTERNAL_ERROR"
)
