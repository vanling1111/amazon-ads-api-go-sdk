...
type CreateAssetBasedCreativeSettings struct {
	...
	CallToActions *CreateAssetBasedCreativeCallToAction `json:"callToActions,omitempty"`
	...
	CustomVideos *CreateVideo `json:"customVideos,omitempty"`
	...
	LandingPage *CreateComponentLandingPage `json:"landingPage,omitempty"`
