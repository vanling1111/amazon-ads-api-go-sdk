...
type Rasv1AdEligibilityErrorReason string

// List of RASv1AdEligibilityErrorReason
const (
	AD_INELIGIBLE_Rasv1AdEligibilityErrorReason Rasv1AdEligibilityErrorReason = "AD_INELIGIBLE"
)
